...
const SUGGESTIONS = [
  ...
  },
  {
    line: 6,
    type: "warning",
    msg: "Sensitive data exposed in response body",
    c: "#f59e0b",
  },
  {
    line: 9,
    type: "suggestion",
    msg: "Add rate limiting to this endpoint",
    c: "#818cf8",
  },
  {
    line: 12,
    type: "praise",
    msg: "Good use of try/catch pattern",
    c: "#34d399",
  },
];
...
const CODE = [
  ...
  },
  {
    ...
    src: [
      ["pl", "  "],
      ["kw", "return "],
      ["pl", "db.users.create({ name, email, hash });"],
    ],
  },
  { n: 8, src: [["pl", "}"]] },
  { n: 9, src: [] },
  { n: 10, src: [["cm", "// route config"]], hl: "#818cf8" },
  {
    n: 11,
    src: [
      ["kw", "export "],
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md">
            ...
            <p className="text-sm mb-8 dp-race-up" style={{ color: "#475569" }}>
              Join thousands of devs getting AI-powered reviews, real-time
